...
const MemDashboard = () => {
  ...
  const navItems = [
    { to: "/member/overview", label: "Overview", icon: <FaHome /> },
    {
      to: "/member/donationhistory",
    ...
    <div className="flex min-h-[92vh] bg-gray-100">
      ...
      >
        <h2 className="text-2xl font-bold mb-6 flex items-center gap-2">
          <span className="text-xl ">Member Dashboard</span>
        </h2>
      ...
      <div className="flex-1 flex flex-col">
        <header className="flex items-center justify-between bg-white p-4 shadow-md">
          ...
          <h2 className="text-lg font-bold">Welcome, Member!</h2>
          {/* <img
            src={assets.user}
            alt="profile"
